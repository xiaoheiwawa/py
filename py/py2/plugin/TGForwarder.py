...
if __name__ == '__main__':
    channels_groups_monitor = ['xx123pan','zyfb123','pan123_share']
    forward_to_channel = 'douerpan123'
    # 监控最近消息数
    limit = 20
    ...
    exclude = [
        '走拉新购买会员得10%返利','软件','音乐','乐队','用户链接','@share_123pan_bot','share_123pan_bot'
    ]
    ...
    message_md = (
        "**推荐播放器：** [uz影视](https://t.me/uzvideoplay)\n\n"
